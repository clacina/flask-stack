...
class ProcessorBase(metaclass=abc.ABCMeta):
    ...
    def process_transactions(self, file_id):
        """
        ...
        for transaction in self.transactions:
            ...
            data_processing.db_utils.add_transaction(conn, transaction, file_id)

    def match_templates(self, file_id: int, processed_batch_id: int):
        """
